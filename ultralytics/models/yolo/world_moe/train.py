...
from ultralytics.nn.tasks import WorldModel_MoE
...
class WorldTrainerMoE(DetectionTrainer):
    """
    ...
    def get_model(self, cfg=None, weights: Optional[str] = None, verbose: bool = True) -> WorldModel_MoE:
        """
